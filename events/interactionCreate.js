    ...
    if (interaction.customId == "open-ticket") {
      ...
      interaction.guild.channels.create(`ticket-${interaction.user.username}`, {
        ...
        const embed = new client.discord.MessageEmbed()
          .setColor('6d6ee8')
          .setAuthor('Ticket', 'https://cdn.discordapp.com/attachments/1026956289768689735/1026956315794350080/space.png')
          .setDescription('Séléctionnez la catégorie de votre ticket')
          .setFooter('SpaceDev', 'https://cdn.discordapp.com/attachments/1026956289768689735/1026956315794350080/space.png')
          .setTimestamp();
        ...
        collector.on('collect', i => {
          if (i.user.id === interaction.user.id) {
            ...
            if (i.values[0] == 'CHANGE') {
              c.edit({
                parent: client.config.parentSpaceDev
              });
            };
            if (i.values[0] == 'CHANGE') {
              c.edit({
                parent: client.config.parentSpaceDev2
              });
            };
            if (i.values[0] == 'CHANGE') {
              c.edit({
                parent: client.config.parentSpaceDev3
              });
            };
            if (i.values[0] == 'CHANGE') {
              c.edit({
                parent: client.config.parentSpaceDev4
              });
            };
          };
        });
      ...
      chan.messages.fetch().then(async (messages) => {
        ...
        hastebin.createPaste(a, {
          ...
          .then(function (urlToPaste) {
            const embed = new client.discord.MessageEmbed()
              .setAuthor('Logs Ticket', 'https://cdn.discordapp.com/attachments/1026956289768689735/1026956315794350080/space.png')
